...
"Place this exact matte black 3D-printed clip — identical to the reference: a flat thin wedge-shaped clamp with one small short round ring, same proportions, visible FDM print layer lines — slid onto the edge of a car's folded-down sun visor (a flat padded panel above the windscreen). A folded blank paper note is gripped in the flat jaw and a single pen lies HORIZONTALLY through the small ring, parallel to the visor's lower edge (the real product holds the pen sideways, never upright). Dark car interior, windscreen and visor, warm low sunlight coming through the glass from the right, deep amber glow, near-black shadows, cinematic contrast, film grain. Realistic photograph, shallow depth of field. Blank papers, no text, no logos. Landscape composition."
